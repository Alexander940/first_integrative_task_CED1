...
public class ShowListPriorityPatientsGeneralGUI extends Stage {

    private TableView<Patient> tableView;

    public ShowListPriorityPatientsGeneralGUI() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/ShowListPriorityPatientsGeneralGUI.fxml"));
            ...
            tableView.setItems(MedicalCenter.getInstance().getListPriorityPatientsGeneral());
