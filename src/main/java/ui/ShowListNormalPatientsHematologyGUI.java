...
public class ShowListNormalPatientsHematologyGUI extends Stage {

    private TableView<Patient> tableView;

    public ShowListNormalPatientsHematologyGUI() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/ShowListNormalPatientsHematologyGUI.fxml"));
            ...
            tableView.setItems(MedicalCenter.getInstance().getListNormalPatientsHematology());
