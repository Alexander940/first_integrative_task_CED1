...
public class ShowListNormalPatientsGeneralGUI extends Stage {

    private TableView<Patient> tableView;

    public ShowListNormalPatientsGeneralGUI() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/ShowListNormalPatientsGeneralGUI.fxml"));
            ...
            tableView.setItems(MedicalCenter.getInstance().getListNormalPatientsGeneral());
